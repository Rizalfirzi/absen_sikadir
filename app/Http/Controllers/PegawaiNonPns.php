...
class PegawaiNonPns extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($pegawai);
        return view('admin.pegawai_non_pns.index', compact('direktorats', 'pegawai'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.pegawai_non_pns.create', compact('direktorats'));
    }

    ...
    y.extend(B.prototype, {
                ...
                (r = function (t) {
                    for (var n, e, o = 0, i = t.length; o < i; o++)
                        (n = t[o].conf),
                            (e = t[o].node),
                            !n.key ||
                                (n.key !== s && (!y.isPlainObject(n.key) || n.key.key !== s || (n.key.shiftKey && !a.shiftKey) || (n.key.altKey && !a.altKey) || (n.key.ctrlKey && !a.ctrlKey) || (n.key.metaKey && !a.metaKey))) ||
        ...
        (B.buttonSelector = function (t, n) {
            for (
                var c = [],
                    u = function (t, n, e) {
                        for (var o, i, s = 0, a = n.length; s < a; s++) (o = n[s]) && (t.push({ node: o.node, name: o.conf.name, idx: (i = e !== w ? e + s : s + "") }), o.buttons) && u(t, o.buttons, i + "-");
                    },
                    d = function (t, n) {
                        var e = [],
                            o =
        ...
        e.Api.register("buttons.exportInfo()", function (t) {
            return { filename: n((t = t || {})), title: a(t), messageTop: r(this, t.message || t.messageTop, "top"), messageBottom: r(this, t.messageBottom, "bottom") };
        });
    var i,
        n = function (t) {
            var n;
            return (n = "function" == typeof (n = "*" === t.filename && "*" !== t.title && t.title !== w && null !== t.title && "" !== t.title ? t.title : t.filename) ? n() : n) === w || null === n
                ? null
                : (n = (n = -1 !== n.indexOf("*") ? n.replace("*", y("head > title").text()).trim() : n).replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "")) + (s(t.extension) || "");
        },
        s = function (t) {
        ...
        c = function (e, t) {
            for (
                var o = y.extend(
                    ...
                    i = (e.select && "function" == typeof e.select.info && i.selected === w && e.rows(o.rows, y.extend({ selected: !0 }, i)).any() && y.extend(i, { selected: !0 }), e.rows(o.rows, i).indexes().toArray()),
